let products = [
    ...
    },
    {
      ...
      price: 300,
      isBuy: true,
      img: "https://paragraf.uz/wp-content/uploads/2021/06/A51.jpg",
      category: ["smartphone"],
   },
 ];
 ...
 products.forEach((e)=>{
   let card =createElement('div', 'card m-4 shadow', `
            
               <img src="${e.img}" alt="smartphone">
               <div class="card-body">
                  <h4>${e.name}</h4>
                  <p>Brand: <strong>${e.brand}</strong> </p>
...
//  let numbers =[1,2,3,4,5,6,7,22,12,22,3,8,15,25]
...
//       ` <img  src="${e.img}" alt="smartphone" class="card-img">
//        <div class="card-body">
